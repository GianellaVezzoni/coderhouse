...
mongoose
  ...
  .then(() => {
    ...
    models.estudiantes
      ...
      .then(() => {
        models.estudiantes.find({ curso: "2A" }).then((estudiantes) => {
          console.log("c");
          console.log(estudiantes);
          return;
        });
      ...
      .then(() => {
        models.estudiantes.find({ nota: 10 }).then((estudiante) => {
          console.log("f");
          console.log(estudiante);
          return;
        });
      ...
      .then(() => {
        models.estudiantes.find().then((estudiantes) => {
          console.log("g");
          let notaTotal = 0;
      ...
      .then(() => {
        models.estudiantes.find({ curso: "1A" }).then((estudiantes) => {
          console.log("h");
          let notaTotal = 0;
          estudiantes.forEach((estudiante) => {
            notaTotal += estudiante.nota;
